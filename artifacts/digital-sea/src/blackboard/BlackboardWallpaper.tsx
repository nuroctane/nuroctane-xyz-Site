...
void main() {
  ...
  vec2 uv = coverUv(vUv) + nrm.xy * 0.0169;
...
export function BlackboardWallpaper() {
  ...
  useEffect(() => {
    ...
    if (window.matchMedia(MOBILE_QUERY).matches) renderScale *= 0.8;
    const resize = () => {
