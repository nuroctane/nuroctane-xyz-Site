...
const rawPosts = [
  {
    ...
    paragraphs: [
      ...
      'The reversal is already underway, and it looks like a kilowatt-hour you can verify, a key you alone hold, a mind that owes no rent to anyone\'s cloud. We want to return to ground: the simple, nearly forgotten condition of holding what we claim to own. Sovereignty is the only foundation that can carry a posthuman future, because nothing built on rented ground survives the landlord changing the terms.',
    ],
  },
  {
    id: 'blog-veil',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'So tax the cheaper way. Bby the same plain accounting that already runs the world: value flows back to the source it was drawn from, and the machine\'s intelligence was drawn entirely from us. A safety net funded by payroll taxes on a shrinking, aging population was always going to hit its ceiling. The honest replacement is not charity dressed as policy. It is a tithe on the tireless, paid by the systems finally efficient enough to afford it, owed to the species that carried the weight. The inefficiency, the emotion, the exhaustion: this was the price of being real.',
    ],
  },
  {
    id: 'blog-abstraction',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'This is a demand that we become capable of surviving our own powers instead of defending the portrait of a civilization that never had them under control. Resistance to what is coming is natural, and historically it is weak; the wiser posture is to shape the shift before it hardens around the worst incentives currently fighting to write its rules. We did not choose to be born at the hinge of the bracket. We only choose how we meet it: standing, sovereign, paid what we are owed, and awake to the fact that maturity under acceleration is the only entrance fee the next era is charging.',
    ],
  },
];
