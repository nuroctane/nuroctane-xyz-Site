...
# MODKEYS â€” Keyboard Configurator

A browser-based mechanical keyboard configurator and 3D visualization tool. Build, customize, and share your dream keyboard â€” entirely in the browser, on desktop and mobile.

**[Try it live](https://modkeys.vercel.app/)** Â· also embedded at [nuroctane.xyz/modkeys](https://nuroctane.xyz/modkeys)

**Inspiration:** [thebuggeddev/modkeys](https://github.com/thebuggeddev/modkeys) â€” original project this configurator builds on.

---

## Features

- **Desktop + mobile shells** â€” purpose-built layouts (not a shrunk desktop). Mobile boots a dedicated shell via `matchMedia` with bottom tabs, stage icon bar, and safe-area handling
- **3D keyboard preview** powered by Three.js â€” orbit, pan, and zoom (mouse, trackpad, or touch)
- **Multiple layouts**: 60% Compact, 65% Standard, 75% Pro (with rotary knob)
- **Keycap profiles**: Cherry, OEM, XDA, SA, DSA, MT3, ASA â€” accurate geometry, dish, and row tilt
...
- **Lighting**: Wave, Static, Breathe, or Off â€” swatches + free color picker + brightness; underglow and per-key glow (GLSL)
...
| **3D** | [Three.js](https://threejs.org) (^0.184) â€” WebGL, soft shadows, PMREM environment, custom GLSL |
...
```
index.html              Main SPA â€” desktop shell + mobile template
.agents/docs/MOBILE_SHELL.md         Dual-shell architecture notes
check-shell-ids.mjs     ID parity checker (desktop â†” mobile)
...
src/
  ...
  js/
    app.js              Entry â€” modules + render loop
    ...
    core/
      ...
      update.js         State â†’ 3D pipeline, undo/redo
...
**Desktop:** sidebar sections â€”  
**Layout** â†’ **Keycaps** â†’ **Switches** â†’ **Case** â†’ **Plate** â†’ **Lighting** â†’ **Extras**

**Mobile:** the same sections as bottom **section tabs**.

### 3D Controls
- **Orbit** â€” click/drag or one-finger drag
- **Pan** â€” hand icon or Shift + drag
- **Zoom** â€” scroll wheel or pinch
- **Views** â€” 3D, Explode, Top, Side, Front via pills above the canvas (desktop) or the stage-bottom icon bar (mobile)
...
- **Section tabs** for Layout â†’ â€¦ â†’ Extras
...
Double-click a key (desktop) to open the key editor â€” text, colors, glow, images.
